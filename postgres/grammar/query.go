...
// Insert 生成插入语句
func Insert(table metadata.ITable, entry dbfactory.IDbModel) (sql string, args []interface{}) {
	var bf bytes.Buffer
...
func Update(table metadata.ITable, entry dbfactory.IDbModel, fields []string, args ...interface{}) (sql string, newArgs []interface{}) {
	var bf bytes.Buffer
...
func Delete(table metadata.ITable, entry dbfactory.IDbModel, args ...interface{}) (sql string, newArgs []interface{}) {
	var bf bytes.Buffer
