...
type repository struct {
	ctx            context.Context
	repositoryBase *dbfactory.RepositoryBase
	pool           *pool
	uow            *unitOfWork
}
...
// args 0 filter
func (r repository) Delete(entry dbfactory.IDbModel, args ...interface{}) (err error) {
...
func (r *repository) Query() dbfactory.IQuery {
	return &query{
		ctx:       r.ctx,
		pool:      r.pool,
