...
func (u *unitOfWork) commitCreate(entry dbfactory.IDbModel) {
	u.createQueue = append(u.createQueue, commitQueueInfo{
		entry: entry,
	})
}

func (u *unitOfWork) commitDelete(entry dbfactory.IDbModel, args ...interface{}) {
...
func (u *unitOfWork) commitUpdate(entry dbfactory.IDbModel, args ...interface{}) {
...
func (u *unitOfWork) getCollection(entry dbfactory.IDbModel) (collectionDb *mongo.Collection) {
